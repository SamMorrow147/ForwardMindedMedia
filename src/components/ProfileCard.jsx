...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(266,100%,90%,var(--card-opacity)) 4%,hsla(266,50%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(266,25%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(266,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#7303c0c4 0%,#03001e00 100%),radial-gradient(100% 100% at 50% 50%,#ec38bcff 1%,#fdeff900 76%),conic-gradient(from 124deg at 50% 50%,#03001eff 0%,#7303c0ff 25%,#ec38bcff 50%,#fdeff9ff 75%,#03001eff 100%)';

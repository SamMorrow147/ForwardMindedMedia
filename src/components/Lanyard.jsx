...
// Asset files downloaded from React Bits repository - using public URLs
...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true, lanyardPosition = [0, 4, 0] }) {
...
function Band({ maxSpeed = 50, minSpeed = 0, lanyardPosition = [0, 4, 0] }) {
  const band = useRef(),
    fixed = useRef(),
    j1 = useRef(),
    j2 = useRef(),

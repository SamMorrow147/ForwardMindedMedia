...
export default function HeroTextSection() {
  ...
  return (
    <section className="pt-4 md:pt-20 pb-40 text-center relative bg-[#2a1232]" style={{ pointerEvents: 'none' }}>

      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        {/* Headline */}
        <h2
          className="font-bold mt-16 mb-4 md:mb-5 hero-title"
        ...
        {/* Subheadline */}
        <p className="text-lg md:text-xl text-white/90 mb-12 leading-relaxed hero-subtext">
